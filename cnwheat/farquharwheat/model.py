    ...
    def calculate_An(cls, t, organ_, PAR_linear_interpolation, Ta, ambient_CO2, RH, wind0):
        ...
        :Parameters:
            ...
            - `PAR_linear_interpolation` (:func:`scipy.interpolate.interpolate.interp1d`) - a function 
              whose call method uses interpolation to find the value of PAR (�mol m-2 s-1).
        ...
        :Returns:
            Net assimilation (�mol m-2 s-1) and Tr (mm s-1)
        ...
        """
        #: Organ parameters
        PAR = PAR_linear_interpolation(t)     #: �mol m-2 s-1
