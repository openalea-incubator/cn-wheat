...
def compute_CN_distrib(run_simu=True, make_graphs=True):
    ...
    if make_graphs:
        ...
        ax1.errorbar(t_NEMA, dry_mass_ph_NEMA_H3, yerr=dry_mass_ph_NEMA_H3_SD, marker = 'o', color = 'g', linestyle = '')
        ...
        ax1.errorbar(t_NEMA[1:], dry_mass_grains_NEMA_H3, yerr=dry_mass_grains_NEMA_H3_SD, label= 'H3', marker = 's', color = 'y', linestyle = '')
        ...
        ax1.errorbar(t_NEMA[1:], dry_mass_tot_NEMA_H3[1:], yerr=dry_mass_tot_NEMA_H3_SD[1:], label= 'H3', marker = 's', color = 'r', linestyle = '')
        ...
        ax1.errorbar(t_NEMA, N_mass_ph_NEMA_H3, yerr=N_mass_ph_NEMA_H3_SD,  marker = 's', color = 'g', linestyle = '')
        ...
        ax1.errorbar(t_NEMA[1:], N_mass_grains_NEMA_H3, yerr=N_mass_grains_NEMA_H3_SD, label= 'H3', marker = 's', color = 'y', linestyle = '')
        ...
        ax1.errorbar(t_NEMA[1:], N_tot_NEMA_H3[1:], yerr=N_tot_NEMA_H3_SD[1:], label = 'H3', marker = 's', color = 'r', linestyle = '')
        ...
        ## NEMA
        ax1.errorbar(t_NEMA[:-1], green_area_lamina1_H3, yerr=green_area_lamina1_H3_SD, label = 'La1 H3', marker = 's', color = 'b', linestyle = '')
        ax1.errorbar(t_NEMA[:-1], green_area_lamina2_H3, yerr=green_area_lamina2_H3_SD, label = 'La2 H3', marker = 's', color = 'g', linestyle = '')
        ax1.errorbar(t_NEMA[:-2], green_area_lamina3_H3, yerr=green_area_lamina3_H3_SD, label = 'La3 H3', marker = 's', color = 'r', linestyle = '')
        ax1.errorbar(t_NEMA[:-2], green_area_lamina4_H3, yerr=green_area_lamina4_H3_SD, label = 'La4 H3', marker = 's', color = 'c', linestyle = '')
        ...
        ## NEMA
        ax1.errorbar(t_NEMA, N_tot_lamina1_H3, yerr=N_tot_lamina1_H3_SD, label = 'La1 H3', marker = 's', color = 'b', linestyle = '')
        ax1.errorbar(t_NEMA, N_tot_lamina2_H3, yerr=N_tot_lamina2_H3_SD, label = 'La2 H3', marker = 's', color = 'g', linestyle = '')
        ax1.errorbar(t_NEMA, N_tot_lamina3_H3, yerr=N_tot_lamina3_H3_SD, label = 'La3 H3', marker = 's', color = 'r', linestyle = '')
        ax1.errorbar(t_NEMA, N_tot_lamina4_H3, yerr=N_tot_lamina4_H3_SD, label = 'La4 H3', marker = 's', color = 'c', linestyle = '')
        ...
        ## NEMA
        ax1.errorbar(t_NEMA, N_tot_stem_H3, yerr=N_tot_stem_H3_SD, label = 'Stem H3', marker = 's', color = 'b', linestyle = '')
        ax1.errorbar(t_NEMA, N_tot_chaff_H3, yerr=N_tot_chaff_H3_SD, label = 'Chaff H3', marker = 's', color = 'g', linestyle = '')
        ...
        ## NEMA
        ax1.errorbar(t_NEMA, DM_tot_lamina1_H3, yerr=DM_tot_lamina1_H3_SD, label = 'La1 H3', marker = 's', color = 'b', linestyle = '')
        ax1.errorbar(t_NEMA, DM_tot_lamina2_H3, yerr=DM_tot_lamina2_H3_SD, label = 'La2 H3', marker = 's', color = 'g', linestyle = '')
        ax1.errorbar(t_NEMA, DM_tot_lamina3_H3, yerr=DM_tot_lamina3_H3_SD, label = 'La3 H3', marker = 's', color = 'r', linestyle = '')
        ax1.errorbar(t_NEMA, DM_tot_lamina4_H3, yerr=DM_tot_lamina4_H3_SD, label = 'La4 H3', marker = 's', color = 'c', linestyle = '')
        ...
        ## NEMA
        ax1.errorbar(t_NEMA, DM_tot_stem_H3, yerr=DM_tot_stem_H3_SD, label = 'Stem H3', marker = 's', color = 'b', linestyle = '')
        ax1.errorbar(t_NEMA, DM_tot_chaff_H3, yerr=DM_tot_chaff_H3_SD, label = 'Chaff H3', marker = 'o', color = 'b', linestyle = '')
