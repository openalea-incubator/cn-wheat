...
class HiddenZone(Organ):
    ...
    def calculate_Unloading_Sucrose(self, sucrose, sucrose_phloem, mstruct_axis):
        """Rate of sucrose Unloading from phloem to the hidden zone (�mol C sucrose unloaded g-1 mstruct h-1).
        ...
        :Returns:
            Rate of Sucrose Unloading (�mol C h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Unloading_Amino_Acids(self, amino_acids, amino_acids_phloem, mstruct_axis):
        """Rate of amino acids Unloading from phloem to the hidden zone (�mol N amino acids unloaded g-1 mstruct h-1).
        Transport-resistance equation
        ...
        :Parameters:
            ...
            - `mstruct_axis` (:class:`float`) -The structural dry mass of the axis (g)
        :Returns:
            Rate of Amino_acids Unloading (�mol N h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_S_proteins(self, amino_acids):
        ...
        :Returns:
            Rate of Protein synthesis (�mol N g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_D_Proteins(self, proteins):
        ...
        :Returns:
            Rate of Protein degradation (�mol N g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_S_Fructan(self, sucrose, Regul_S_Fructan):
        ...
        :Returns:
            Rate of Fructan synthesis (�mol C g-1 mstruct)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_D_Fructan(self, sucrose, fructan):
        ...
        :Returns:
            Rate of Fructan degradation (�mol C g-1 mstruct)
        :Returns Type:
            :class:`float`
        """
...
class Grains(Organ):
    ...
    def calculate_S_grain_structure(self, prec_structure, RGR_Structure):
        ...
        :Returns:
            Rate of Synthesis of grain structure (�mol C h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_S_grain_starch(self, sucrose_phloem, mstruct_axis):
        ...
        :Parameters:
            ...
            - `mstruct_axis` (:class:`float`) -The structural dry mass of the axis (g)
        :Returns:
            Rate of Synthesis of grain starch (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
        if self.age_from_flowering <= Grains.PARAMETERS.FILLING_INIT:   #: Grain enlargment
...
class Roots(Organ):
    ...
    def calculate_Unloading_Sucrose(self, sucrose_phloem, mstruct_axis):
        ...
        :Parameters:
            ...
            - `mstruct_axis` (:class:`float`) -The structural dry mass of the axis (g)
        :Returns:
            Rate of Sucrose Unloading (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Uptake_Nitrates(self, Conc_Nitrates_Soil, nitrates_roots, sucrose_roots):
        ...
        :Returns:
            Nitrate uptake (�mol N nitrates) and nitrate influxes HATS and LATS (�mol N h-1)
        :Returns Type:
        ...
        VMAX_HATS_MAX = Roots.PARAMETERS.A_VMAX_HATS * np.exp(-Roots.PARAMETERS.LAMBDA_VMAX_HATS * conc_nitrates_roots)  #: Maximal rate of nitrates influx at saturating soil N concentration;HATS (�mol N nitrates g-1 mstruct s-1)
        K_HATS = Roots.PARAMETERS.A_K_HATS * np.exp(-Roots.PARAMETERS.LAMBDA_K_HATS * conc_nitrates_roots)               #: Affinity coefficient of nitrates influx at saturating soil N concentration;HATS (�mol m-3)
    ...
    def calculate_S_amino_acids(self, nitrates, sucrose):
        ...
        :Returns:
            Amino acids synthesis (�mol N g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Export_Nitrates(self, nitrates, regul_transpiration):
        ...
        :Returns:
            Rate of Export of nitrates (�mol N h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_exudation(self, Unloading_Sucrose, sucrose_roots, amino_acids_roots, amino_acids_phloem):
        ...
        :Parameters:
            - `Unloading_Sucrose` (:class:`float`) - Sucrose Unloading (�mol C g-1 mstruct h-1)
            - `sucrose_roots` (:class:`float`) - Amount of sucrose in roots (�mol C)
        ...
        :Returns:
            Rates of C exudated (�mol C g-1 mstruct h-1) and N_exudation (�mol N g-1 mstruct h-1)
        :Returns Type:
            :class:`tuple` of 2 :class:`float`
        """
...
class PhotosyntheticOrganElement(object):
    ...
    def calculate_total_Photosynthesis(self, Ag, green_area):
        ...
        :Returns:
            Rate of Total Photosynthesis (�mol C h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Regul_S_Fructan(self, Loading_Sucrose):
        ...
        :Parameters:
            - `Loading_Sucrose` (:class:`float`) - Sucrose loading (�mol C)
        :Returns:
            Maximal rate of fructan synthesis (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
        if Loading_Sucrose <= 0:
    ...
    def calculate_S_Starch(self, triosesP):
        ...
        :Returns:
            Rate of Starch synthesis (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_D_Starch(self, starch):
        ...
        :Returns:
            Starch degradation (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_S_Sucrose(self, triosesP):
        ...
        :Parameters:
            - `triosesP` (:class:`float`) - Amount of triose phosphates (�mol C)
        :Returns:
            Rate of Sucrose synthesis (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Loading_Sucrose(self, sucrose, sucrose_phloem, mstruct_axis):
        ...
        :Returns:
            Rate of Sucrose loading (�mol C h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_export_sucrose(self, sucrose, sucrose_hiddenzone, mstruct_hiddenzone):
        ...
        :Returns:
            Rate of Sucrose export (�mol C h-1)
        :Returns Type:
            :class:`float`
        """
        conc_sucrose_element = sucrose / (self.mstruct*self.__class__.PARAMETERS.ALPHA)
    ...
    def calculate_S_Fructan(self, sucrose, Regul_S_Fructan):
        ...
        :Parameters:
            ...
            - `Regul_S_Fructan` (:class:`float`) - Maximal rate of fructan synthesis regulated by sucrose loading (�mol C g-1 mstruct)
        :Returns:
            Rate of Fructan synthesis (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_D_Fructan(self, sucrose, fructan):
        ...
        :Parameters:
            ...
            - `fructan` (:class:`float`) - Amount of fructan (�mol C)
        :Returns:
            Rate of Fructan degradation (�mol C g-1 mstruct h-1)
        :Returns Type:
            :class:`float`
        """
        d_potential = ((PhotosyntheticOrgan.PARAMETERS.K_DFRUCTAN * PhotosyntheticOrgan.PARAMETERS.VMAX_DFRUCTAN) /
    ...
    def calculate_S_amino_acids(self, nitrates, triosesP):
        ...
        :Returns:
            Rate of Amino acids synthesis (�mol N h-1 g-1 mstruct)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_S_proteins(self, amino_acids):
        ...
        :Parameters:
            - `amino_acids` (:class:`float`) - Amount of amino acids (�mol N).
        :Returns:
            Protein synthesis (�mol N h-1 g-1 mstruct)
        :Returns Type:
            :class:`float`
        """
    ...
    def calculate_Export_Amino_Acids(self, amino_acids, amino_acids_hiddenzone, mstruct_hiddenzone):
        ...
        :Parameters:
            ...
            - `mstruct_hiddenzone` (:class:`float`) - mstruct of the hidden zone (g)
        :Returns:
            Rate of Amino acids export (�mol N h-1)
        :Returns Type:
            :class:`float`
        """
        Conc_Amino_Acids_element = amino_acids / (self.mstruct*self.__class__.PARAMETERS.ALPHA)
...
class Soil(object):
    ...
    def calculate_mineralisation(self):
        ...
        :Returns:
            Rate of Nitrate mineralisation (�mol h-1)
        :Returns Type:
            :class:`float`
        """
