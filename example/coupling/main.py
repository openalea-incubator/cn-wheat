...
def compute_CN_distrib():
    ...
    graph_variables_organs = {'Conc_Sucrose':u'[Sucrose] (µmol g$^{-1}$ mstruct)', 'Dry_Mass':'Dry mass (g)',
                        ...
                        'R_grain_growth_struct_YG': u'Respiration grain structural growth (µmol C h$^{-1}$)', 'R_grain_growth_starch_YG': u'Respiration grain starch growth (µmol C h$^{-1}$)',}
...
##    profile.run('compute_CN_distrib()', filename)
