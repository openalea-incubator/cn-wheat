...
graph_variables_ph_elements = {'An': u'Net photosynthesis (µmol m$^{-2}$ s$^{-1}$)', 'Transpiration':u'Organ transpiration (mm H$_{2}$0 h$^{-1}$)', 'Rd': u'Mitochondrial respiration rate of organ in light (µmol m$^{-2}$ s$^{-1}$)', 'Ts': u'Temperature surface (µC)', 'gs': u'Conductance stomatique (mol m$^{-2}$ s$^{-1}$)',
                   ...
                   'green_area': u'Green area (m$^{2}$)', 'R_phloem': u'Respiration phloem loading (µmol h$^{-1}$)', 'R_Nnit_red': u'Respiration nitrate reduction (µmol h$^{-1}$)', 'R_residual': u'Respiration residual (µmol h$^{-1}$)'}
...
graph_variables_ph_elements = {'Conc_Sucrose':u'[Sucrose] (µmol g$^{-1}$ mstruct)', 'Dry_Mass':'Dry mass (g)',
                    ...
                    'R_Nnit_upt': u'Respiration nitrates uptake (µmol h$^{-1}$)', 'R_Nnit_red': u'Respiration nitrate reduction (µmol h$^{-1}$)', 'R_residual': u'Respiration residual (µmol h$^{-1}$)'}
