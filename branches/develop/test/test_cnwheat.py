...
def test_simulation_run(write_desired_files=False):
    ...
    inputs_dataframes = {}
    for inputs_filename in (ORGANS_INITIAL_STATE_FILENAME, HIDDENZONES_INITIAL_STATE_FILENAME, ELEMENTS_INITIAL_STATE_FILENAME, SOILS_INITIAL_STATE_FILENAME):
    ...
    for (outputs_df_list,
        ...
        cnwheat_tools.compare_actual_to_desired(OUTPUTS_DIRPATH, outputs_df, desired_outputs_filename,
                                                actual_outputs_filename, precision=PRECISION, write_desired_files=write_desired_files)


def test_simulation_run_with_interpolation(write_desired_files=False):
...
def test_simulation_logging(write_desired_files=False):
    ...
    for (desired_compartments_filename,
        ...
        cnwheat_tools.compare_actual_to_desired(LOGS_DIRPATH, actual_compartments_df, desired_compartments_filename, precision=PRECISION, write_desired_files=write_desired_files)
    # Derivatives logs
    for (desired_derivatives_filename,
        ...
        try:
            ...
            continue  # This file is empty: ignore it.
        cnwheat_tools.compare_actual_to_desired(LOGS_DIRPATH, actual_derivatives_df, desired_derivatives_filename, precision=PRECISION, write_desired_files=write_desired_files)


def test_postprocessing(write_desired_files=False):
    ...
    for (postprocessing_file_basename,
        ...
        cnwheat_tools.compare_actual_to_desired(POSTPROCESSING_DIRPATH, actual_postprocessing_df, desired_postprocessing_filename,
                                                actual_postprocessing_filename, precision=PRECISION, write_desired_files=write_desired_files)
