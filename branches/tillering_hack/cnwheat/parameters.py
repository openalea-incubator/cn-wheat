...
class RootsParameters(object):
    ...
    def __init__(self):
        ...
        self.K_C = 8000#7000                      #: Affinity coefficient for the regulation function by root C (:math:`\mu` mol C sucrose g-1 MS)
        ...
        # Nitrate export
        self.K_NITRATE_EXPORT = 1E-6 * 150 #120   #: Relative rate of nitrate export from roots (s-1)
        ...
        self.K_AMINO_ACIDS_EXPORT = 3E-5 * 60 #: Relative rate of amino acids export from roots (s-1)

        # Exudation
        self.C_EXUDATION = 0.20               #: Proportion of C exudated from C sucrose unloaded to roots (Keith et al., 1986)

        # Cytokinins
        self.VMAX_S_CYTOKININS = 4.5E-04*2    #: Maximal rate of cytokinins synthesis (UA g-1 mstruct s-1)
        ...
        self.K_CYTOKININS_EXPORT = 2E-4 /3     #: Relative rate of cytokinins export from roots (s-1)
